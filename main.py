...
# --- მხოლოდ სტატისტიკა (ახალი) ---
@bot.message_handler(commands=['stats'])
def admin_stats(message):
    # ეს მხოლოდ ადმინის ჯგუფში იმუშავებს
    if message.chat.id == ADMIN_GROUP_ID:
        user_count = len(data.get("topics", {}))
        bot.reply_to(message, f"📊 **სტატისტიკა:**\n\n👥 სულ მომხმარებელი: **{user_count}**\n✅ სისტემა მუშაობს.", parse_mode="Markdown")

# --- სტანდარტული ჰენდლერები (ძველი და მუშა) ---
